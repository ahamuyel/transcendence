...
-- Add unique constraint for Result table
CREATE UNIQUE INDEX "Result_studentId_subjectId_trimester_academicYearId_key" ON "Result"("studentId", "subjectId", "trimester", "academicYearId");
