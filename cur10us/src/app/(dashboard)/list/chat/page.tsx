        ...
        {conversations.length === 0 ? (
          ...
          <div className="space-y-1">
            {conversations.map((c) => (
              ...
              >
                <div className="w-10 h-10 rounded-full bg-indigo-100 dark:bg-indigo-950/40 flex items-center justify-center text-sm font-bold text-indigo-600 dark:text-indigo-400 overflow-hidden flex-shrink-0">
                  {c.other.image ? (
