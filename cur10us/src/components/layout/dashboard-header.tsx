  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between px-3 sm:px-4 py-2.5 sm:py-3 border-b border-zinc-200 dark:border-zinc-800 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md gap-2 min-h-[57px]">
      ...
      <div className="hidden md:block relative" ref={dropdownRef}>
        <div className="flex items-center gap-2 px-3 py-2 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900 text-xs text-zinc-500 focus-within:border-indigo-500 focus-within:bg-white dark:focus-within:bg-zinc-950 transition-all">
      ...
      {/* Mobile logo */}
      <Link href="/dashboard" className="md:hidden flex items-center gap-1.5 shrink-0 ml-auto mr-auto">
      ...
      <div className="flex items-center gap-1 sm:gap-2 ml-auto">
        ...
        >
          ...
          <Avatar className="h-8 w-8 border-2 border-zinc-200 dark:border-zinc-700 group-hover:border-indigo-400 dark:group-hover:border-indigo-500 transition-colors">
